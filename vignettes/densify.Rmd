...
The data used in this tutorial are the default data provided in the package: the language-variable matrix `WALS` obtained from WALS, the World Atlas of Language Structures [@wals], and the language taxonomy `glottolog_languoids` provided by Glottolog, Version 5.0 [@glottolog].
...
```{r densify-result illustration, eval = TRUE, echo = TRUE, warning = FALSE, fig.align = 'center', fig.height=6, fig.width=6, fig.cap = 'Quality score plot for `score = n_data_points * coding_density` on the densify result object obtained from an implementation of `densify()` using the settings `scoring = "arithmetic"`, considering taxonomic diversity.'}
# rank results
...
```{r score-2-0, echo = TRUE, warning = FALSE, fig.show="hold", fig.align = 'center', fig.width=6, fig.height=6, warning = FALSE, fig.cap = 'Quality score plots varying the basic trade-off of available data points and coding density in an implementation of `densify()` using the settings `scoring = "arithmetic"`, considering taxonomic diversity. Topmost: `score = n_data_points * coding_density^2`. Second from top: `score = n_data_points * coding_density^3`. Second from bottom: `score = n_data_points^2 * coding_density`. Bottommost: `score = n_data_points^3 * coding_density`.'}
...
```{r prune-plots-1, echo = FALSE, warning=FALSE, fig.show = "hold", out.width = "40%", fig.width = 5, fig.height = 3, fig.cap = 'Coding density for the pruned `WALS` data frame, using the settings `mean = "arithmetic"`, considering taxonomic diversity, using `score = n_data_points * coding_density * taxonomic_index` (left languages, right variables)'}
par(mar = c(4, 4, .1, .1))
...
```{r prune-plots-2, echo = FALSE, warning = FALSE, fig.show = "hold", out.width = "40%", fig.width = 5, fig.height = 3, fig.cap = 'Coding density for the pruned `WALS` data frame, using the settings `mean = "arithmetic"`, considering taxonomic diversity and with `score = n_data_points * coding_density * row_coding_density_min * col_coding_density_min * taxonomic_index` (left languages, right variables)'}
par(mar = c(4, 4, .1, .1))
