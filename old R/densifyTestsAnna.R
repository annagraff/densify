...
#  
# documentation_L_T_2023_0990_0999 <- read.csv("documentation files/documentation_L_T_2023_0990_0999.csv")
# 
# 
# # test F3
...
# ##################################################################################################################################
  ...
  # 
  # set.seed(2023)
  # documentation_ZHM6june_G_F_2023 <- pruning_steps(original_data, max_steps, mean_type, taxonomy, original_register, tax_weight_factor, coding_weight_factor)
  # 
  # write.csv(documentation_ZHM6june_G_F_2023,"documentation files/documentation_ZHM6june_G_F_2023.csv")
  # 
  # 
  # # test F3
  ...
  # 
  # optimum <- pruning_score(documentation_ZHM6june_G_F_2023,exponent_prop_coded_data=exponent_prop_coded_data, exponent_available_data_points=exponent_available_data_points, exponent_lowest_language_score=exponent_lowest_language_score)
  # 
  # # test F4
  # # these two are equivalent
  # pruned_matrix <- densify_prune(original_data, documentation_ZHM6june_G_F_2023, optimum)
  # 
  # 
  # ######### some plots
  # hist(apply(pruned_matrix,1,function(x)(length(na.omit(x))))/ncol(pruned_matrix),col = "cadetblue2",xlab="coding density per language", ylab="frequency")
